...
@section('content')
    ...
    <div class="card">
        ...
        <form method="post" action="{{ route('admin.blog.add.submit') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
            <div class="card-header">
                <h2>Blogs</h2>
                <small>Add a blog.</small>
            </div>

            <div class="card-body card-padding">
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label"> BlogName</label>
                    <div class="col-sm-10">
                        <div class="fg-line">
